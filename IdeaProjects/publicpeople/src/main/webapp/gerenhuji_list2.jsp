...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
 ...
 <% 
    ...
    String url = "gerenhuji_list2.jsp?1=1"; 
    String sql =  "select * from gerenhuji where shenfenzhenghao='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("shenfenzhenghao")=="" ||request.getParameter("shenfenzhenghao")==null ){}else{sql=sql+" and shenfenzhenghao like '%"+request.getParameter("shenfenzhenghao")+"%'";}
 ...
 <td width="60" align="center"><a href="gerenhuji_updt.jsp?id=<%=map.get("id")%>"></a>  <a href="gerenhuji_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')"></a> <a href="gerenhuji_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
