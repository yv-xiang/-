	 ...
	 public static String getFileUpInfo()
		{
			...
			jscode+="<font onclick=\"uploaddoc()\" src=\"js/nopic.jpg\" style='cursor:hand' id=txt >����˴��ϴ�</font>";
	 ...
	 public static String getFileUpInfo2()
		{
			String jscode = "";
			jscode+="<script src=js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc2()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt2 >����˴��ϴ�</font>";
	 ...
	 public static String getFileUpInfo3()
		{
			String jscode = "";
			jscode+="<script src=js/popup.js></script>";
			jscode+="<font onclick=\"uploaddoc3()\" src=\"js/nopic.jpg\" style='cursor:hand' id=filetxt3 >����˴��ϴ�</font>";
