	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("adminlogin"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				{
					sql1 = "select * from gerenhuji where shenfenzhenghao='"+username+"' and mima='"+password+"'"; 
				}
			List<HashMap> userlist1 = dao.select(sql1);
			if(userlist1.size()==1)
			{
				...
				{
					request.getSession(). setAttribute("username", userlist1.get(0).get("shenfenzhenghao"));  
				request.getSession(). setAttribute("cx", utype);  
				} 
