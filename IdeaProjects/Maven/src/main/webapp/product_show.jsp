                ...
                <tr>
                    ...
                    <td align="center">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/register.jsp"><font color="#337AB7">注册</font></a>&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}/login.jsp"><font color="#337AB7">登陆</font></a>&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}/cart.jsp"><font color="#337AB7">购物车</font></a>&nbsp;&nbsp;
                            </c:otherwise>
                        </c:choose>
