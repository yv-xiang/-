...
<table width="100%">
                    ...
                    <td align="center">
                        <c:choose>
                            <c:when test="${user != null}">
                                ...
                                <a href="${pageContext.request.contextPath}/LogoutServlet"><font color="#337AB7">退出</font></a>&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}/AddCartServlet"><font color="#337AB7">购物车</font></a>&nbsp;&nbsp;
                            </c:when>
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/RegisterServlet"><font color="#337AB7">注册</font></a>&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}/LoginServlet"><font color="#337AB7">登陆</font></a>&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}/AddCartServlet"><font color="#337AB7">购物车</font></a>&nbsp;&nbsp;
                            </c:otherwise>
                        </c:choose>
    ...
    <tr>
            ...
            <c:forEach items="${sessionScope.cart}" var="entry">
                ...
                <tr>
                    ...
                    <td width="60" width="40%" style="border-right: 1px solid gray;">
                        ...
                        <img src="${entry.key.proMinImg}" width="70" height="60">
                    </td>
                    ...
                    <td style="border-right: 1px solid gray;">
                        <a href="/DeleteCartServlet?proId=${entry.key.proId}" onclick="return confirm('确定要删除吗？')">删除</a>
                    </td>
                </tr>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    <a href="${pageContext.request.contextPath}/ProductShowServlet">
