            ...
            <c:forEach items="${sessionScope.cart}" var="entry">
                ...
                <tr>
                    ...
                    <td width="60" width="40%" style="border-right: 1px solid gray;">
                        ...
                        <img src="${entry.key.pro_min_img}" width="70" height="60">
                    </td>
                    ...
                    <td style="border-right: 1px solid gray;">
                        <a href="${pageContext.request.contextPath}/DeleteServlet?pro_id=${entry.key.pro_id}" onclick="return confirm('确定要删除吗？')">删除</a>
                    </td>
                </tr>
